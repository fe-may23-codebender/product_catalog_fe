      ...
      <div className={container.limit}>
        ...
        <div className={styles.GridContainer}>
          <article className={styles.About}>
            ...
            <h4 className={styles.About__info}>Shoot it. Flip it. Zoom it. Crop it. Cut it. Light it. Tweak it. Love it.</h4>
            <p className={styles.About__text}>
          ...
          <article className={styles.TechInfo}>
            ...
            <ul className={styles.card__characteristics}>
              ...
              <li className={styles.TechInfo__characteristic}>
                <p>Camera</p>
                <p className={styles.TechInfo__value}>12 Mp + 12 Mp + 12 Mp (Triple)</p>
              </li>
              <li className={styles.TechInfo__characteristic}>
                <p>Zoom</p>
